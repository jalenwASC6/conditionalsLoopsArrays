...
if (enemyAttackType == elements[0]) {
    console.log("It's Super Effective!")
} else if (enemyAttackType == elements[1]) {
    console.log("It's not very effective!")
} else if (enemyAttackType == elements[2]) {
...
console.log(roster[i].substr(0, 1)); console.log(roster[i].substr(roster[i].length-1, roster[i].length));
i++;
}
// ==================================================================
